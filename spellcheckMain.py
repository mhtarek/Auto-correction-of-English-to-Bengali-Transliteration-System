...
from sentenceLevel import multiSelection
...
def main():
    ...
    with open ("./True Value/test data/3.txt", "r",encoding = 'utf-8') as myfile:
            banglish_sentence=myfile.readlines()
    ...
    trueTestData = createTestDataList("./True Value/true data/3True.txt")
    ...
    print("F1-score: ",f1_score(trueTestData, predictedData, average="macro"))
